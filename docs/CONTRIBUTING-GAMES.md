...
You can contribute and add new games to the **Dastet Al3ab** platform either via a **Github Pull Request** (highly recommended) or by submitting a formatted **Email** through our Creator Dashboard.
...
1. Open the Dastet Al3ab app and click on **Add Game** (or navigate to `/creator`).
